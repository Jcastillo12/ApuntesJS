...
/*
    ...
    let convert=(new Set(gameEvents.values()));
    const events = [...new Set(convert)];
    console.log(events);
*/
// Conver set to array
console.log(gameEvents.values());
...
/*
// 4.
Loop over the events and log them to the console, marking whether it's in the first half 
